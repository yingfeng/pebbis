...
var commands = map[string]command{
	...
	"GETEX":    {cmdGetEx, -2, true},
	"DELEX":    {cmdDelex, -2, true},
	"SETBIT":   {cmdSetBit, 3, true},
	"GETBIT":   {cmdGetBit, 2, false},
	"BITCOUNT": {cmdBitCount, -2, false},
	"BITPOS":   {cmdBitPos, -2, false},
	"BITOP":    {cmdBitOp, -3, true},
	"MSET":     {cmdMSet, -3, true},
	...
	"HINCRBYFLOAT": {cmdHIncrByFloat, 4, true},
	...
	"SINTERCARD":  {cmdSInterCard, -3, false},
	...
	"ZREVRANGEBYSCORE": {cmdZRevRangeByScore, -4, false},
	...
	"DEBUG":    {cmdDebug, -1, false},
	"SORT":     {cmdSort, -2, true},
	"SORT_RO":  {cmdSortRO, -2, false},
